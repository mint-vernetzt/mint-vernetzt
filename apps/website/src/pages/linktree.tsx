import { H1, H2, H3, H4 } from "@mint-vernetzt/react-components";
...
export const pageQuery = graphql`
  query LinkTree {
    ...
    Teaser2Image: file(relativePath: { eq: "mintcommunity_puzzle.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 280, quality: 80) {
          ...GatsbyImageSharpFluid
        }
    ...
    Teaser3Image: file(relativePath: { eq: "mintcommunity_hackathon.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 280, quality: 80) {
          ...GatsbyImageSharpFluid
        }
    ...
    Teaser4Image: file(relativePath: { eq: "events_overview.jpeg" }) {
      childImageSharp {
        fluid(maxWidth: 280, quality: 80) {
          ...GatsbyImageSharpFluid
        }
